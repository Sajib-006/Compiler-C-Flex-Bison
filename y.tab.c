...
{
  "$end", "error", "$undefined", "MAIN", "ADDOP", "PRINTLN", "IF", "FOR",
  "CHAR", "RETURN", "VOID", "MULOP", "FLOAT", "INT", "DOUBLE", "ELSE",
  "WHILE", "ASSIGNOP", "RELOP", "LOGICOP", "NOT", "LTHIRD", "INCOP",
  "DECOP", "COMMA", "CONST_FLOAT", "CONST_INT", "ID", "newline", "DO",
  "BREAK", "BITOP", "LPAREN", "RCURL", "LCURL", "RPAREN", "RTHIRD",
  "SEMICOLON", "LOWER_THAN_ELSE", "$accept", "start", YY_NULLPTR
};
#endif
...
#line 1360 "y.tab.c" /* yacc.c:1646  */
  ...
  case 5:
#line 99 "1605064o.y" /* yacc.c:1646  */
    {
		//write your code in this block in all the similar blocks below
...
#line 112 "1605064o.y" /* yacc.c:1906  */
